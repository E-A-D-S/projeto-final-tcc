...
<body style="background-image:url('/img/login.jpg'); margin-left:100px; background-repeat: no-repeat; background-size: 1360px;">
  ...
  <div class="container w-50 " style="margin-top: 20px;">
    ...
    <div class="justify-content-center bg-warning" style="border-radius:5px;">
      ...
      <form method="POST" action="{{ route('register') }}" class="container  mb-3">
        <x-jet-validation-errors class="text-black" />
        @csrf

        <div class="form-outline ">
          <x-jet-label for="name" class="form-label mt-4 text-black" value="{{ __('Name') }}" />
        ...
        <div class="form-outline  ">
          <x-jet-label for=" email" class="form-label mt-4 text-black" value="{{ __('Email') }}" />
          <x-jet-input id="email" class="block mt-1 w-full form-control" type="email" name="email" :value="old('email')" required />
        </div>
        <div class="form-outline ">
          <x-jet-label for="password" class="form-label mt-4 text-black" value="{{ __('Password') }}" />
        ...
        <div class="form-outline ">
          <x-jet-label for="password_confirmation" class="form-label mt-4 text-black" value="{{ __('Confirm Password') }}" />
